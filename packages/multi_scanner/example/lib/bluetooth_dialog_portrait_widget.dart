...
class BluetoothDialogWidget extends StatefulWidget {
  const BluetoothDialogWidget({super.key, required this.isPortrait});

  final bool isPortrait;

  @override
  State<BluetoothDialogWidget> createState() => _BluetoothDialogWidgetState();
}
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: Text("Найденные", style: const TextStyle(fontSize: 13)),
              ),
            ],
          ),
                    ...
                    builder:
                        (
                          ...
                          if (length != 0) {
                            ...
                            return Center(child: Text("не найдено"));
                          }
                        },
                  ),
                ),
