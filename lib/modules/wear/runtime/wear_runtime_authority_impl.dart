...
import 'package:smart_glasses/modules/wear/runtime/wear_runtime_pre_auth_lifecycle_reducer.dart';
        ...
        _store = WearRuntimeStore(
          ...
          reducer: WearAggregateReducer(
            sliceReducers: const <WearSliceReducer>[
              ...
              WearRuntimePresentationReducer(),
              WearPreAuthLifecycleReducer(),
