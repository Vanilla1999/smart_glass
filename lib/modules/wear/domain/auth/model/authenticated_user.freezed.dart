...
mixin _$AuthenticatedUser {
  ...
  int get idEmployee => throw _privateConstructorUsedError;
...
abstract class $AuthenticatedUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({int idUser, int idEmployee, String name});
}
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      idEmployee: null == idEmployee
          ? _value.idEmployee
          : idEmployee // ignore: cast_nullable_to_non_nullable
              as int,
      name: null == name
          ? _value.name
...
class _$AuthenticatedUserImpl implements _AuthenticatedUser {
  _$AuthenticatedUserImpl(
      {required this.idUser, required this.idEmployee, required this.name});
  ...
  @override
  String toString() {
    return 'AuthenticatedUser(idUser: $idUser, idEmployee: $idEmployee, name: $name)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.idEmployee, idEmployee) ||
                other.idEmployee == idEmployee) &&
            (identical(other.name, name) || other.name == name));
  }

  @override
  int get hashCode => Object.hash(runtimeType, idUser, idEmployee, name);
...
abstract class _AuthenticatedUser implements AuthenticatedUser {
  factory _AuthenticatedUser(
      ...
      required final int idEmployee,
      required final String name}) = _$AuthenticatedUserImpl;
