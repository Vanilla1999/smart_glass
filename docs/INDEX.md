...
- [WEAR_STACK_MERGE_REPORT.md](audits/WEAR_STACK_MERGE_REPORT.md) — Final merge ledger, branch cleanup, post-merge fixes, host validation and remaining device gates
